...
import com.newapp.UserLogin;
import com.newapp.service.UserLoginService;
 ...
 * @see UserLogin
 */
@RestController("blobscenarios.UserLoginController")
@Api(value = "UserLoginController", description = "Exposes APIs to work with UserLogin resource.")
@RequestMapping("/blobscenarios/UserLogin")
public class UserLoginController {

    private static final Logger LOGGER = LoggerFactory.getLogger(UserLoginController.class);

    @Autowired
	@Qualifier("blobscenarios.UserLoginService")
...
public UserLogin createUserLogin(@RequestPart("wm_data_json") UserLogin userLogin, @RequestPart(value = "profile", required = false) MultipartFile _profile) {
    ...
    public UserLogin editUserLogin(@PathVariable("id") Integer id, MultipartHttpServletRequest multipartHttpServletRequest) throws EntityNotFoundException {
        UserLogin newUserLogin = WMMultipartUtils.toObject(multipartHttpServletRequest, UserLogin.class, "blobscenarios");
