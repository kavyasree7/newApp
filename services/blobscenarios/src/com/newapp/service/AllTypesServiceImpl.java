 ...
 * @see AllTypes
 */
@Service("blobscenarios.AllTypesService")
@Validated
public class AllTypesServiceImpl implements AllTypesService {
    ...
    @Autowired
    @Qualifier("blobscenarios.AllTypesDao")
    ...
    public Downloadable export(ExportType exportType, String query, Pageable pageable) {
        LOGGER.debug("exporting data in the service blobscenarios for table AllTypes to {} format", exportType);
