 ...
 */
@Service("blobscenarios.AlltypeswithoutspaceService")
@Validated
public class AlltypeswithoutspaceServiceImpl implements AlltypeswithoutspaceService {
    ...
    @Autowired
    @Qualifier("blobscenarios.AlltypeswithoutspaceDao")
    ...
    public Downloadable export(ExportType exportType, String query, Pageable pageable) {
        LOGGER.debug("exporting data in the service blobscenarios for table Alltypeswithoutspace to {} format", exportType);
