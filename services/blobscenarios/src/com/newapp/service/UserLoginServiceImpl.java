 ...
 * @see UserLogin
 */
@Service("blobscenarios.UserLoginService")
@Validated
public class UserLoginServiceImpl implements UserLoginService {
    ...
    @Autowired
    @Qualifier("blobscenarios.UserLoginDao")
    ...
    public Downloadable export(ExportType exportType, String query, Pageable pageable) {
        LOGGER.debug("exporting data in the service blobscenarios for table UserLogin to {} format", exportType);
