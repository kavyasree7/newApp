...
import com.newapp.service.SalaryDetailsService;
...
public class SalaryDetailsController {
    ...
    @Autowired
	@Qualifier("createdb_9.SalaryDetailsService")
...
public SalaryDetails createSalaryDetails(@RequestBody SalaryDetails salaryDetails) {
    ...
    @WMAccessVisibility(value = AccessSpecifier.APP_ONLY)
    public SalaryDetails getSalaryDetails(@PathVariable("id") Integer id) throws EntityNotFoundException {
    ...
    @WMAccessVisibility(value = AccessSpecifier.APP_ONLY)
    public SalaryDetails editSalaryDetails(@PathVariable("id") Integer id, @RequestBody SalaryDetails salaryDetails) throws EntityNotFoundException {
        LOGGER.debug("Editing SalaryDetails with id: {}" , salaryDetails.getId());

        salaryDetails.setId(id);
    ...
    @WMAccessVisibility(value = AccessSpecifier.APP_ONLY)
    public boolean deleteSalaryDetails(@PathVariable("id") Integer id) throws EntityNotFoundException {
