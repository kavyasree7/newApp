...
import com.newapp.service.UserDetailsService;
...
public UserDetails createUserDetails(@RequestPart("wm_data_json") UserDetails userDetailsInstance, @RequestPart(value = "userPic", required = false) MultipartFile _userPic) {
		LOGGER.debug("Create UserDetails with information: {}" , userDetailsInstance);

    userDetailsInstance.setUserPic(WMMultipartUtils.toByteArray(_userPic));
    ...
    public UserDetails editUserDetails(@PathVariable("id") Integer id, MultipartHttpServletRequest multipartHttpServletRequest) throws EntityNotFoundException {
        UserDetails newUserDetails = WMMultipartUtils.toObject(multipartHttpServletRequest, UserDetails.class, "createdb_9");
