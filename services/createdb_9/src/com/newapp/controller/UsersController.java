...
import com.newapp.service.UsersService;
 ...
 * @see Users
 */
@RestController("createdb_9.UsersController")
@Api(value = "UsersController", description = "Exposes APIs to work with Users resource.")
@RequestMapping("/createdb_9/Users")
public class UsersController {

    private static final Logger LOGGER = LoggerFactory.getLogger(UsersController.class);

    @Autowired
	@Qualifier("createdb_9.UsersService")
...
public Users createUsers(@RequestBody Users users) {
    ...
    @RequestMapping(value="/{id:.+}/userDetailses", method=RequestMethod.GET)
    @ApiOperation(value = "Gets the userDetailses instance associated with the given id.")
    @WMAccessVisibility(value = AccessSpecifier.APP_ONLY)
    public Page<UserDetails> findAssociatedUserDetailses(@PathVariable("id") Integer id, Pageable pageable) {

        LOGGER.debug("Fetching all associated userDetailses");
        return usersService.findAssociatedUserDetailses(id, pageable);
    }
