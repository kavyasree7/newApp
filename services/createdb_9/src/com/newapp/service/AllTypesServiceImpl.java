 ...
 * @see AllTypes
 */
@Service("createdb_9.AllTypesService")
@Validated
public class AllTypesServiceImpl implements AllTypesService {
    ...
    @Autowired
    @Qualifier("createdb_9.AllTypesDao")
    ...
    public Downloadable export(ExportType exportType, String query, Pageable pageable) {
        LOGGER.debug("exporting data in the service createdb_9 for table AllTypes to {} format", exportType);
