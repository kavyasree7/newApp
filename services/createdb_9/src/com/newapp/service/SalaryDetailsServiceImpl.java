 ...
 * @see SalaryDetails
 */
@Service("createdb_9.SalaryDetailsService")
@Validated
public class SalaryDetailsServiceImpl implements SalaryDetailsService {
    ...
    @Autowired
    @Qualifier("createdb_9.SalaryDetailsDao")
	...
	@Override
	public SalaryDetails getById(Integer salarydetailsId) throws EntityNotFoundException {
	...
	public SalaryDetails update(SalaryDetails salaryDetails) throws EntityNotFoundException {
        ...
        Integer salarydetailsId = salaryDetails.getId();
    ...
    public Downloadable export(ExportType exportType, String query, Pageable pageable) {
        LOGGER.debug("exporting data in the service createdb_9 for table SalaryDetails to {} format", exportType);
