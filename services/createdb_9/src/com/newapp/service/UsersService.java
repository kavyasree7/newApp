...
public interface UsersService {
    ...
    /*
     * Returns the associated userDetailses for given Users id.
     *
     * @param userId value of userId; value cannot be null
     * @param pageable Details of the pagination information along with the sorting options. If null returns all matching records.
     * @return Paginated list of associated UserDetails instances.
     *
     * @see Pageable
     * @see Page
     */
    Page<UserDetails> findAssociatedUserDetailses(Integer userId, Pageable pageable);
