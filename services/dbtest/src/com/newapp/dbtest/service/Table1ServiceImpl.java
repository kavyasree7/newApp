...
package com.newapp.dbtest.service;
...
import com.newapp.dbtest.Table1;
...
public class Table1ServiceImpl implements Table1Service {
    ...
    @Transactional(value = "dbtestTransactionManager")
    @Override
	...
	@Transactional(readOnly = true, value = "dbtestTransactionManager")
	@Override
	...
	@Transactional(rollbackFor = EntityNotFoundException.class, value = "dbtestTransactionManager")
	@Override
    ...
    public Downloadable export(ExportType exportType, String query, Pageable pageable) {
        LOGGER.debug("exporting data in the service dbtest for table Table1 to {} format", exportType);
